...
class Index
{
    ...
    function getToken(){
        return $this->checkAccessToken("wx68b360e27ec55883","f063ecc66a063211912b42892b28701d");
    }
       ...
       "button":[
        {
            "type":"view",
            "name":"天气查询",
            "url":"http://www.messj.xyz/index/forecast/index.html"
        }]
      }';
      $access_token=$this->getToken();
    ...
    public function getuser(){
         ...
         //echo "<div><img src=\"$user_info[\"headimgurl\"]\"  alt=\"上海鲜花港 - 郁金香\" /></div>";
